...
check_out_correct_submodule_versions: ## Fetches all Submodules and checks out specified branch
	...
	@# release. They have also held a real branch during feature work (T2S_API_GIT_BRANCH=master,
	...
	-if git -C ${T2S_APIS_DIR} symbolic-ref -q HEAD >/dev/null; then git -C ${T2S_APIS_DIR} pull; fi
