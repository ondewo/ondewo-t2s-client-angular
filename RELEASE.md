...
## Release ONDEW T2S Angular Client 5.2.0

### Improvements

* Tracking API Vesion [5.2.0](https://github.com/ondewo/ondewo-t2s-api/releases/tag/5.1.0) ( [Documentation](https://ondewo.github.io/ondewo-t2s-api/) )
...
* Optimized for Agular 16 (esm2022 and fesm2022)
...
## Release ONDEW T2S Angular Client 2.0.0
