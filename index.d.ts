...
declare class Text2SpeechClient {
	...
	$raw: {
		 ...
		 */
		synthesize: (
			requestData: SynthesizeRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<SynthesizeResponse>>;
		/**
		 ...
		 */
		normalizeText: (
			requestData: NormalizeTextRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<NormalizeTextResponse>>;
		/**
		 ...
		 */
		getT2sPipeline: (
			requestData: T2sPipelineId,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<Text2SpeechConfig>>;
		/**
		 ...
		 */
		createT2sPipeline: (
			requestData: Text2SpeechConfig,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<T2sPipelineId>>;
		/**
		 ...
		 */
		listT2sPipelines: (
			requestData: ListT2sPipelinesRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<ListT2sPipelinesResponse>>;
		/**
		 ...
		 */
		listT2sLanguages: (
			requestData: ListT2sLanguagesRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<ListT2sLanguagesResponse>>;
		/**
		 ...
		 */
		listT2sDomains: (
			requestData: ListT2sDomainsRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<ListT2sDomainsResponse>>;
		/**
		...
		listT2sNormalizationPipelines: (
			requestData: ListT2sNormalizationPipelinesRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<ListT2sNormalizationPipelinesResponse>>;
		/**
		...
		getServiceInfo: (
			...
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<T2SGetServiceInfoResponse>>;
		/**
		 ...
		 */
		getCustomPhonemizer: (
			requestData: PhonemizerId,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<CustomPhonemizerProto>>;
		/**
		...
		createCustomPhonemizer: (
			requestData: CreateCustomPhonemizerRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<PhonemizerId>>;
		/**
		...
		updateCustomPhonemizer: (
			requestData: UpdateCustomPhonemizerRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<CustomPhonemizerProto>>;
		/**
		...
		listCustomPhonemizer: (
			requestData: ListCustomPhonemizerRequest,
			requestMetadata?: GrpcMetadata
		) => Observable<GrpcEvent<ListCustomPhonemizerResponse>>;
	};
	...
	listT2sPipelines(
		requestData: ListT2sPipelinesRequest,
		requestMetadata?: GrpcMetadata
	): Observable<ListT2sPipelinesResponse>;
	/**
	 * Unary call @/ondewo.t2s.Text2Speech/ListT2sLanguages
	 *
	 * @param requestMessage Request message
	...
	listT2sLanguages(
		requestData: ListT2sLanguagesRequest,
		requestMetadata?: GrpcMetadata
	): Observable<ListT2sLanguagesResponse>;
	/**
	 * Unary call @/ondewo.t2s.Text2Speech/ListT2sDomains
	 *
	 * @param requestMessage Request message
	...
	listT2sDomains(
		requestData: ListT2sDomainsRequest,
		requestMetadata?: GrpcMetadata
	): Observable<ListT2sDomainsResponse>;
	/**
	 * Unary call @/ondewo.t2s.Text2Speech/ListT2sNormalizationPipelines
	 *
	 * @param requestMessage Request message
	...
	listT2sNormalizationPipelines(
		requestData: ListT2sNormalizationPipelinesRequest,
		requestMetadata?: GrpcMetadata
	): Observable<ListT2sNormalizationPipelinesResponse>;
	/**
	 * Unary call @/ondewo.t2s.Text2Speech/GetServiceInfo
	 *
	 * @param requestMessage Request message
	...
	getServiceInfo(
		requestData: googleProtobuf001.Empty,
		requestMetadata?: GrpcMetadata
	): Observable<T2SGetServiceInfoResponse>;
	/**
	 * Unary call @/ondewo.t2s.Text2Speech/GetCustomPhonemizer
	 *
	 * @param requestMessage Request message
	...
	updateCustomPhonemizer(
		requestData: UpdateCustomPhonemizerRequest,
		requestMetadata?: GrpcMetadata
	): Observable<CustomPhonemizerProto>;
	/**
	 * Unary call @/ondewo.t2s.Text2Speech/ListCustomPhonemizer
	 *
	 * @param requestMessage Request message
	...
	listCustomPhonemizer(
		requestData: ListCustomPhonemizerRequest,
		requestMetadata?: GrpcMetadata
	): Observable<ListCustomPhonemizerResponse>;
